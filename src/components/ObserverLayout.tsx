...
const NAV: NavLeaf[] = [
  { label: "Inicio", icon: <Home size={18} />, href: "/observer/dashboard" },
  { label: "Elecciones", icon: <Landmark size={18} />, href: "/observer/elecciones" },
  { label: "Resultados", icon: <BarChart2 size={18} />, href: "/observer/resultados" },
  { label: "Asociaciones", icon: <Users size={18} />, href: "/observer/asociaciones" },
  { label: "Padrón de Votantes", icon: <LayoutDashboard size={18} />, href: "/observer/votantes" },
]
            ...
            {showLabels && (
              <>
                <div className="min-w-0 flex-1 text-left">
                  ...
                  <p className="text-xs text-white/60">Observador</p>
                </div>
                {userMenuOpen ? (
